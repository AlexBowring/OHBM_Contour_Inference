...
Vout.fname = 'RAW20LowerConfidenceInterval.nii'; % crucially, change the file name!
...
Vout=VY(1); % clone the first image's handle
Vout.fname = 'RAW20MiddleConfidenceInterval.nii'; % crucially, change the file name!
...
Vout=VY(1); % clone the first image's handle
Vout.fname = 'RAW20UpperConfidenceInterval.nii'; % crucially, change the file name!
