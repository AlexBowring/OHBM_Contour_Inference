...
Vout.fname = 'RAWLowerConfidenceInterval.nii'; % crucially, change the file name!
...
Vout=VY(1); % clone the first image's handle
Vout.fname = 'RAWMiddleConfidenceInterval.nii'; % crucially, change the file name!
...
Vout=VY(1); % clone the first image's handle
Vout.fname = 'RAWUpperConfidenceInterval.nii'; % crucially, change the file name!
